  ...
  return (
    <div className={styles.page}>
      ...
      <ol className={styles.stepGrid}>
        ...
        <li><span>02</span><h2>切换课堂模式</h2><p>点击主题页上方“课堂模式”，地址会加入 <code>?mode=classroom</code>。</p></li>
        <li><span>03</span><h2>投屏或分享</h2><p>进入全屏，或展示本机生成的二维码供学生打开同一主题。</p></li>
        <li><span>04</span><h2>围绕证据讨论</h2><p>8—15 分钟完成主流程，来源、局限与必要图例始终可见。</p></li>
      </ol>
      ...
      <section className={styles.twoColumnText}>
        <div><h2>课堂模式会改变</h2><ul><li>更大的正文和关键标题</li><li>更低的控件密度</li><li>全屏和二维码入口</li><li>适合逐步讲解的布局</li></ul></div>
